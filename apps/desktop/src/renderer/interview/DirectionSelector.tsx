...
import { INTERVIEW_DIRECTION_PRESETS, TECHNICAL_DOMAIN_LABELS, TECHNICAL_DOMAINS, type InterviewDirectionMode, type InterviewDirectionPreset, type InterviewDirectionSelection, type TechnicalDomain } from "@interview-copilot/shared";
