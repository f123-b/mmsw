...
export function App(): JSX.Element {
  ...
  const probeAudio = async () => {
    try { await window.interviewCopilot.audio.probe({ inputDeviceId, outputDeviceId }); }
