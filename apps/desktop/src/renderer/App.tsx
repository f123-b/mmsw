...
function asrDefaultModel(providerType: AsrProviderType): string {
  return providerType === "qwen" ? "qwen3-asr-flash-realtime-2026-02-10" : "nova-3";
}
...
export function App(): JSX.Element {
  ...
  const startInterview = async () => {
    try {
      ...
      if (asrProviderType !== "custom-gateway" && !preflight.asr.configured) throw new Error(`ASR_AUTH_FAILED: 未配置${asrProviderType === "qwen" ? "千问" : " Deepgram"} API Key`);
